...
const StartSwap = () => {
  ...
  const [file, setFile] = useState(null); // ✅ This was missing
  ...
  const handlePick = async () => {
    try {
      ...
      setFile(res[0]);  // Save full file object
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.buttonRow}>
        ...
        <TouchableOpacity
            style={[styles.nextButton, (!file || !billType) && styles.nextButtonDisabled]}
            disabled={!file || !billType}
